...
/** F1 panel: timings, quality, water/physics internals. F2–F6 switch water debug views. */
export class DebugUI {
  ...
  update(_dt: number): void {
    ...
    this.el.textContent = [
      ...
      `view  ${g.view}   [F2 final F3 normals F4 caustics F5 refl F6 depth]   music ${g.music.now}`,
      ``,
